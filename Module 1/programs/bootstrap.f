...
c============================================
	...
	implicit integer (i-n)
        parameter(nfake=500,nlatt = 20, nvol = nlatt**2)
	real q(50000),b(50000),p(50000),a(50000)

    
        call ranstart
        
        open(2,file='chi.txt',status='unknown')
        open(3,file='input.txt',status='unknown')
        open(4,file='data',status='unknown')
