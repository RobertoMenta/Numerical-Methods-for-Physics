...
CC=====================================================
      ...
      parameter (nlatt = 200, nvol = nlatt**2)
      real field
...
cc apertura file sul quale scrivere le misure della magnetizzazione e energia
...
c     read(1,*) extfield       !!valore del campo esterno
...
c=================================================================
      parameter (nlatt = 12,nvol = nlatt**2)
